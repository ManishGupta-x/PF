...
// Helper function to get all image keys for state management
...
// Helper function to create initial state object for images
...
// Helper function to render paragraph content with links
...
// data.js - Small Projects Page Data
export const smallProjectsData = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: "It was a project i made in an hackathon with a good friend of mine. We created a web application where were we took help of Bard AI to Schedule and Plan our tasks effectively onto the weekdays and weekends. Depending upon various factors like the difficulty of the task, the time required to complete it, and the priority level, the AI would suggest an optimal schedule for the user. This project was a great learning experience in integrating AI with web development and understanding user needs for productivity tools. We Submitted this project in a hackathon which resulted in us winning the consolation prize.",
      image: {
...
// Helper function to render project title (with or without link)
...
// Helper function to render project image (if exists)
...
// Helper function to render footer stars
